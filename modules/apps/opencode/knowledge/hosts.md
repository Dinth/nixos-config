...
- `r230-proxmox` (`10.10.1.16`) is the Proxmox hypervisor running the
  `r230-nixos` (`10.10.1.12`), `homeassistant` (`10.10.1.11`), `wazuh`
  (`10.10.1.18`), and pfSense (`10.10.0.1`) VMs. The `omv` NAS (`10.10.1.13`)
  is a separate physical box.
